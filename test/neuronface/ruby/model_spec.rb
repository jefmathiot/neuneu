...
describe Neuronface::Model do
  it "creates the backend on initalization" do
    _(Neuronface::Model.new(backend: :ruby).instance_variable_get(:@backend))
      .must_be_instance_of Neuronface::Ruby::Backend
  end
  ...
  describe "with a backend mock" do
    ...
    it "plots history" do
      history = Neuronface::Ruby::History.new
  ...
  it "provides history" do
    _(Neuronface::Model.new.history.get(:training)).must_equal []
  end
end
